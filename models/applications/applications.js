...
function getById(id) {
    let query = db
    .select('applications.id', 'animals.name as animal_name', 'shelters.shelter', 'application_status.application_status', 'applications.application_status_id', 'applications.user_id', 'application_meta.*') 
    .from('applications')

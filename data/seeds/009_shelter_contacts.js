exports.seed = async function(knex, Promise) {
  ...
  .then(function () {
      ...
      return knex('shelter_contacts').insert([
        {shelter_id: 1 , name: "Juby", email: "anotherEmail@email.com", phone:"212-512-2525"},
        ...
        {shelter_id: 4 , name: "Hung", email: "hung@email.com", phone:"225-512-2525"},
        ...
        {shelter_id: 9 , name: "Kermitt", email: "kermitt@email.com", phone:"642-512-2525"},
